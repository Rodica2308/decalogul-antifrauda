...
import { Award, ThumbsUp, BookOpen, ArrowRight } from "lucide-react";
    ...
    <div className="mt-4 sm:mt-8 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden max-w-3xl mx-auto">
      <div className="bg-primary px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center">
          <h2 className="text-xs xs:text-sm sm:text-base md:text-lg font-semibold text-white mb-1 md:mb-0">
            Decalogul Antifraudă - 10 întrebări pentru siguranța banilor tăi
          </h2>
          {!quizCompleted && (
        ...
        {!quizCompleted ? (
          <div>
            {questions[currentQuestionIndex].category && (
              <span className="inline-block mb-2 px-2 py-1 bg-amber-100 text-amber-800 text-[0.65rem] sm:text-xs font-semibold rounded-full uppercase tracking-wide">
                {questions[currentQuestionIndex].category}
              </span>
            )}
          ...
          <div className="text-center">
            <div className="mb-6">
              ...
              {score >= questions.length * 0.7 && score < questions.length && (
                <div>
                  ...
                  <p className="mt-2 text-lg text-gray-600">
                    Ai cunoștințe solide despre siguranța bancară.
                  </p>
                </div>
              )}
              ...
              {score >= questions.length / 2 &&
                score < questions.length * 0.7 && (
                  <div>
                    ...
                    <p className="mt-2 text-lg text-gray-600">
                      Ai cunoștințe bune despre siguranța bancară.
                    </p>
                  </div>
                )}
              ...
              {score < questions.length / 2 && (
                <div>
                  ...
                  <p className="mt-2 text-lg text-gray-600">
                    Ai nevoie de mai multe informații pentru a te proteja
                    eficient.
                  </p>
                </div>
              )}
            ...
            <div className="mb-6">
              ...
              <p className="mt-1 text-gray-600">
                Procentaj: {Math.round((score / questions.length) * 100)}%
              </p>
            </div>
            ...
            <div className="mb-8 max-w-lg mx-auto bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              {score === questions.length && (
                <p className="text-gray-700">
                  Excelent! Ai toate cunoștințele necesare pentru a te proteja
                  împotriva fraudelor bancare. Ești vigilent și știi exact cum
                  să identifici și să eviți tentativele de înșelăciune.
                </p>
              )}
              ...
              {score >= questions.length * 0.7 && score < questions.length && (
                <div className="text-gray-700">
                  <p>
                    Foarte bun rezultat! Ai cunoștințe solide despre securitatea
                    bancară și poți identifica majoritatea tentativelor de
                    fraudă. Continuă să fii vigilent și să-ți actualizezi
                    informațiile despre metodele de fraudă.
                  </p>
                  <p className="mt-2 text-yellow-600 font-medium">
                    Ai fost păcălit totuși{" "}
                    {questions.length - score === 1
                      ? "o dată"
                      : `de ${questions.length - score} ori`}
              ...
              {score >= questions.length / 2 &&
                score < questions.length * 0.7 && (
                  <div className="text-gray-700">
                    <p>
                      Ai cunoștințe bune, dar există loc de îmbunătățire. Te
                      sfătuim să acorzi o atenție deosebită aspectelor legate de
                      verificarea surselor comunicărilor și să nu oferi
                      niciodată date confidențiale prin canale nesigure.
                    </p>
                    <p className="mt-2 text-orange-600 font-medium">
                      Ai fost păcălit de {questions.length - score} ori!
                      Fraudatorii ar putea profita de aceste vulnerabilități!
                    </p>
                  </div>
                )}
              ...
              {score < questions.length / 2 &&
                score > questions.length * 0.3 && (
                  <div className="text-gray-700">
                    <p>
                      Ai cunoștințe de bază, dar este important să îți
                      îmbunătățești vigilența. Învață să recunoști semnele de
                      avertizare ale fraudelor și nu acționa niciodată sub
                      presiune sau din sentiment de urgență când e vorba de
                      datele și banii tăi.
                    </p>
                    <p className="mt-2 text-red-600 font-medium">
                      Ai fost păcălit de {questions.length - score} ori! Ești
                      expus la riscuri semnificative de fraudă!
                    </p>
                  </div>
                )}
              ...
              {score <= questions.length * 0.3 && (
                <div className="text-gray-700">
                  <p>
                    Este necesar să acorzi mai multă atenție siguranței bancare
                    online. Fraudele sunt tot mai sofisticate și este esențial
                    să înveți cum să te protejezi. Reține că banca nu îți va
                    cere niciodată detalii confidențiale precum parole sau
                    PIN-uri.
                  </p>
                  <p className="mt-2 text-red-700 font-bold">
                    Ai fost păcălit de {questions.length - score} ori! Ești
                    foarte vulnerabil la fraude! Studiază cu atenție
